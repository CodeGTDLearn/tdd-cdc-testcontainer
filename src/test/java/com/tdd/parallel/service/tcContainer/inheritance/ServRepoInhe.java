...
@Slf4j
@DisplayName("ServRepoInhe")
@Import({ServRepoStandard.class})
public class ServRepoInhe extends TestscontainerConfigInhe {
  ...
  public void deleteById() {
    ...
    Mono<PersonStandard> personMono = serviceMongoRepo.findById(personList.get(0)
                                                                          .getId());
