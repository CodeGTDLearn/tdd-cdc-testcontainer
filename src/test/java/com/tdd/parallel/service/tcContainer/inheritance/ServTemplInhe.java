...
@Slf4j
@DisplayName("ServTemplInhe")
@Import({ServiceTemplateStandardCfg.class})
public class ServTemplInhe extends TestscontainerConfigInhe {
  ...
  public void deleteById() {
    ...
    Mono<PersonStandard> personMono = serviceTemplateRepo.findById(personList.get(0)
                                                                             .getId());
