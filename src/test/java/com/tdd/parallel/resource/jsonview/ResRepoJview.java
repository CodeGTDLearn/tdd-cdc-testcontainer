...
@DisplayName("ResRepoJview")
@Import({ServRepoJsonview.class})
@MergedAnnotations
public class ResRepoJview {
  ...
  @Autowired
  private IService<PersonJsonview> servRepoJsonview;
  ...
  public void saveAdmin() {
    PersonJsonview localPerson = utils.personJsonview_save_check(servRepoJsonview);
    ...
    utils.findPersonInDb(servRepoJsonview.findById(localPerson.getId()),1L);
  }
  ...
  public void findByIdAdmin() {
    ...
    RestAssuredWebTestClient
         ...
         .when()
         .get(JV_REQ_MAP + JV_REPO_ADMIN + JV_ID,localPerson.getId())
  ...
  public void findByIdUser() {
    ...
    RestAssuredWebTestClient
         ...
         .when()
         .get(JV_REQ_MAP + JV_REPO_USER + JV_ID,localPerson.getId())
  ...
  public void deleteById() {
    ...
    RestAssuredWebTestClient
         ...
         .when()
         .delete(JV_REQ_MAP + JV_REPO_DEL + JV_ID,localPerson.getId())
    ...
    utils.findPersonInDb(servRepoJsonview.findById(localPerson.getId()),0L);
  }
